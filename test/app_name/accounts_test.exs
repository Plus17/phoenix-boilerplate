defmodule AppName.AccountsTest do
  use AppName.DataCase

  alias AppName.Accounts

  alias AppName.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "registers users with a hashed password" do
      ...
      {:ok, user} =
        Accounts.register_user(params_for(:user, email: email, password: valid_user_password()))
    ...
    test "allows fields to be set" do
      ...
      changeset =
        Accounts.change_user_registration(
          %User{},
          params_for(:user, email: email, password: valid_user_password())
        )
